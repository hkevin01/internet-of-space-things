...
- [x] Fast suite validated: **102 passed, 0 warnings** (`tests/test_core_systems.py`, `tests/test_ml_pipelines.py`, `tests/test_sensors_telemetry.py`, `tests/test_iosct.py`).
...
- [x] Runtime `utcnow` deprecation cleanup completed across core/runtime modules; full and fast suites now run warning-free.
...
| <sub>2017</sub> | <sub>Karacalioglu et al. (incl. Mehdi Lali)</sub> | <sub>The Future of Internet of Things and Their Applicability to Space</sub> | <sub>[IAC-17,B5,1,4,x39795](https://iafastro.directory/iac/archive/browse/IAC-17/B5/1/39795/)</sub> | <sub>IoST mission framing and cross-domain architecture motivation</sub> |
...
<sub>Last updated: May 29, 2026 | Project completion: 80% | Target: IAC 2027 | IAC 2027 demo preparation: active</sub>
